...
from run.run_xgb import add_features_xgb, drop_columns_xgb
...
def main():
    ...
    data_dev = add_features_xgb(data_dev, categorical_columns, mode='train')
    data_dev = drop_columns_xgb(data_dev)
